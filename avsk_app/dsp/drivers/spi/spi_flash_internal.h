...
struct spi_flash *spi_flash_probe_atmel(struct spi_slave *spi, unsigned char *idcode);
struct spi_flash *spi_flash_probe_macronix(struct spi_slave *spi, unsigned char *idcode);
struct spi_flash *spi_flash_probe_sst(struct spi_slave *spi, unsigned char *idcode);
struct spi_flash *spi_flash_probe_stmicro(struct spi_slave *spi, unsigned char *idcode);
struct spi_flash *spi_flash_probe_winbond(struct spi_slave *spi, unsigned char *idcode);
