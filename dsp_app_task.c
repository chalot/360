 ...
 *
 */
#define	WIN_WITDTH				(736-320)	//(736-270)	//466
#define	WIN_HEIGHT				480
#define	WIN_START_X				320//270	//屏幕起始显示位置
...
#define SEP_WIDTH				WIN_WITDTH	//466 //(736-270)
#define SEP_HEIGHT				4
...
//	tUIFsm.u8PendingCommand = 0xFF;
	...
	case	PAGE_AllVIEW:
		...
		else if(eKeyType == KEY_REAR)
		{
			...
			if(tUIFsm.u8CurrentPage == PAGE_REAR_FULL) {
				Show_Page(PAGE_REAR);
			}
			else {
				Show_Page(PAGE_REAR);
