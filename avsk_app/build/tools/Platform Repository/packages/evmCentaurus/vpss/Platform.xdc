...
instance :
    ...
    override config string codeMemory  = "CODE_CORE_VPSS_M3";   
    override config string dataMemory  = "PRIVATE_DATA_CORE_VPSS_M3";                                
    override config string stackMemory = "PRIVATE_DATA_CORE_VPSS_M3";
